CREATE TYPE "public"."credit_debit_28" AS ENUM('Credit', 'Debit');--> statement-breakpoint
CREATE TYPE "public"."expense_type_28" AS ENUM('Fixed', 'Variable');--> statement-breakpoint
CREATE TYPE "public"."subscription_tier_28" AS ENUM('Free', 'Pro Monthly', 'Pro Lifetime');--> statement-breakpoint
CREATE TYPE "public"."type_28" AS ENUM('Income', 'Savings', 'Expenses');--> statement-breakpoint
...
CREATE TABLE "user_categories" (
	...
	"category_type" "type_28" NOT NULL,
	"expense_method" "expense_type_28",
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "user_transactions" (
	...
	"transaction_type" "type_28" NOT NULL,
	...
	"transaction_credit_debit" "credit_debit_28",
	"isClaimable" boolean,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "user_subscriptions" (
	...
	"tier" "subscription_tier_28" NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
