CREATE TYPE "public"."credit_debit_22" AS ENUM('Credit', 'Debit');--> statement-breakpoint
CREATE TYPE "public"."expense_type_22" AS ENUM('Fixed', 'Variable');--> statement-breakpoint
CREATE TYPE "public"."subscription_tier_22" AS ENUM('Free', 'Pro (Monthly)', 'Pro (One Time Purchase)');--> statement-breakpoint
CREATE TYPE "public"."type_22" AS ENUM('Income', 'Savings', 'Expenses');--> statement-breakpoint
CREATE TABLE "user_categories" (
	"category_id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"clerk_user_id" text NOT NULL,
	"category_name" text NOT NULL,
	"category_budget" double precision NOT NULL,
	"category_type" "type_22" NOT NULL,
	"expense_method" "expense_type_22",
...
CREATE TABLE "user_subscriptions" (
	...
	"tier" "subscription_tier_22" NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
