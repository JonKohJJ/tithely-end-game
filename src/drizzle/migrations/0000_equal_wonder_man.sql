CREATE TYPE "public"."credit_debit_type_29" AS ENUM('Credit', 'Debit');--> statement-breakpoint
CREATE TYPE "public"."expense_type_29" AS ENUM('Fixed', 'Variable');--> statement-breakpoint
CREATE TYPE "public"."subscription_tier_type_29" AS ENUM('Free', 'Pro Monthly', 'Pro Lifetime');--> statement-breakpoint
CREATE TYPE "public"."type_29" AS ENUM('Income', 'Savings', 'Expenses');--> statement-breakpoint
...
CREATE TABLE "user_categories" (
	...
	"category_type" "type_29" NOT NULL,
	"expense_method" "expense_type_29",
	"saving_goal" double precision,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	...
	CONSTRAINT "Category Type is Savings / Savings goal value expected" CHECK ("user_categories"."category_type" != 'Savings' OR "user_categories"."saving_goal" IS NOT NULL)
);
--> statement-breakpoint
...
CREATE TABLE "user_transactions" (
	...
	"transaction_type" "type_29" NOT NULL,
	...
	"transaction_credit_debit" "credit_debit_type_29",
	"isClaimable" boolean,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "user_subscriptions" (
	...
	"tier" "subscription_tier_type_29" NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
