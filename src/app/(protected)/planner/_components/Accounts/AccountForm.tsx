...
export default function AccountForm({
    ...
    async function onDelete(accountToDelete: TFetchedAccountWithChildTransactionCount) {
            ...
            <DialogContent className="max-w-xl bg-color-bg border-color-border">
                ...
                {dialogMode === 'Delete' && (
                    <>
                        ...
                        <p>{accountTobeEdited?.childTransactionsCount} transaction(s) linked to this account will remain, but they will no longer be associated with any account.</p>
                        <p>{`Are you sure?`}</p>
